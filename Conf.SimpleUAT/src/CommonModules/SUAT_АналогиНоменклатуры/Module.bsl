...
// Оприходывать только по главному аналогу.
// 
// Возвращаемое значение:
//  Булево - Оприходывать только по главному аналогу
Функция ОприходыватьТолькоПоГлавномуАналогу() Экспорт
	
	УстановитьПривилегированныйРежим(Истина);
	Результат =  Константы.SUAT_ОприходованиеТолькоПоГлавномуАналогу.Получить();
